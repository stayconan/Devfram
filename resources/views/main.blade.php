...
<head>
    ...
    <title>@yield('title') - Klinik Medical Lampung</title>
    ...
    <link rel="stylesheet" href="{{ asset('style/vendors/themify-icons/css/themify-icons') }}">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">Klinik Medical</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('edulevels')}}"> <i class="menu-icon fa fa-home"></i>Edulevels</a>
                    </li>
                    <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-list"></i><a href="ui-buttons.html">Katalog Obat</a></li>
                            <li><i class="fa fa-tag"></i><a href="ui-badges.html">Stock Obat</a></li>
                            <li><i class="fa fa-bookmark"></i><a href="ui-tabs.html">Opname Barang</a></li>
                            <li><i class="fa fa-database"></i><a href="ui-social-buttons.html">Data Penjualan</a></li>
                            <li><i class="fa fa-id-card-o"></i><a href="ui-cards.html">Cards</a></li>
                            <li><i class="fa fa-exclamation-triangle"></i><a href="ui-alerts.html">Alerts</a></li>
                            <li><i class="fa fa-spinner"></i><a href="ui-progressbar.html">Progress Barang</a></li>
                        </ul>
                    </li>
